...
let APP_BUILD = "2026.04.24 #1 16:18"
...
class LocalizationManager {
    ...
    private let translations: [String: [String: String]] = [
        ...
        "de": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Im Dock anzeigen",
            "other.show_in_dock_desc": "Speechy-Symbol im Dock anzeigen.",
        ],
        "fr": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Afficher dans le Dock",
            "other.show_in_dock_desc": "Afficher l'icône Speechy dans le Dock.",
        ],
        "it": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Mostra nel Dock",
            "other.show_in_dock_desc": "Mostra l'icona di Speechy nel Dock.",
        ],
        "nl": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Toon in Dock",
            "other.show_in_dock_desc": "Speechy-pictogram in Dock weergeven.",
        ],
        "ja": [
            "nav.hotkeys": "ショートカット",
            "nav.advanced": "詳細設定",
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Dockに表示",
            "other.show_in_dock_desc": "SpeechyアイコンをDockに表示します。",
        ],
        "ko": [
            "nav.hotkeys": "단축키",
            "nav.advanced": "고급",
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Dock에 표시",
            "other.show_in_dock_desc": "Dock에 Speechy 아이콘을 표시합니다.",
        ],
        "ar": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "إظهار في Dock",
            "other.show_in_dock_desc": "عرض أيقونة Speechy في Dock.",
        ],
        "hi": [
            "nav.hotkeys": "हॉटकी",
            "nav.advanced": "उन्नत",
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Dock में दिखाएं",
            "other.show_in_dock_desc": "Dock में Speechy आइकन दिखाएं।",
        ],
        "id": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Tampilkan di Dock",
            "other.show_in_dock_desc": "Tampilkan ikon Speechy di Dock.",
        ],
        "vi": [
            ...
            "section.dock": "Dock",
            "other.show_in_dock": "Hiện trong Dock",
            "other.show_in_dock_desc": "Hiển thị biểu tượng Speechy trong Dock.",
        ],
    ]
}
...
// Apply dock visibility from saved preference (default: visible)
        ...
        // Set up Edit menu so Cmd+C/V/X/A work in text fields
        setupEditMenu()
    ...
    func setupEditMenu() {
        ...
        let appMenu = NSMenu()
        appMenu.addItem(NSMenuItem(title: "Quit Speechy", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
